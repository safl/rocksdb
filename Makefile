...
BENCHMARKS = db_bench table_reader_bench cache_bench memtablerep_bench column_aware_encoding_exp persistent_cache_bench nvm_bench
...
release:
	...
	DEBUG_LEVEL=0 $(MAKE) static_lib tools nvm_bench
